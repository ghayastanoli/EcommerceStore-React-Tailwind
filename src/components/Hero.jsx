      ...
      style={{ backgroundImage: `url(${myImage})` }}>
        <div>
          <div className='flex justify-end'>
            <div className='bg-white flex mr-6 p-2 px-3 rounded-b-xl text-sm hover:bg-orange-500 hover:text-white transition duration-300'>
        ...
        <div>
          <button type='button' className='m-16 mt-10 px-8 py-2 bg-orange-500 rounded-md font-jak font-semibold text-white hover:bg-orange-700 transition duration-300'>SHOP NOW</button>
        </div>
