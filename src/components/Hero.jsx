  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url(${myImage})` }}>
        ...
        <h4 className='px-6  sm:px-8 md:px-16 text-xs md:text-md lg:text-xl font-mont text-white max-w-[215px] sm:max-w-[350px] md:max-w-[500px] lg:max-w-[600px]'>Find what you love, love what you find. Start shopping today and <span className='font-bold md:3xl text-xl'>save big.</span> </h4>
        </div>
        </div>
        <div className='max-w-[1350px] m-auto w-[100%]'>
