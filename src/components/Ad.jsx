  ...
  return (
    ...
    <div className=' sm:mx-14'>
        ...
        style={{ backgroundImage: `url(${myImage})` }}>
            ...
            <div className='font-jak text-2xl min-[692px]:text-4xl md:text-5xl font-bold flex justify-center sm:justify-end px-4 sm:px-16 pt-10 text-white text-left'>
                <div>
            ...
            <div className='flex justify-end sm:justify-end sm:mr-16 font-jak text-white sm:font-semibold  '>
                <button type='button' className='px-2 min-[802px]:px-6 py-2 sm:py-2 mt-2 mr-24 sm:mr-1 shadow-md rounded-md bg-orange-500 hover:bg-orange-600 transition-all duration-200'>Explore Now</button>
            </div>
            </div>
        </div>
    </div>
