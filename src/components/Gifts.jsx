  ...
  return (
    ...
    <div>
        <div className='px-10 sm:px-16 py-8 max-w-[1350px] m-auto w-[100%]'>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 justify-items-center'>
                ...
                <div className='cursor-pointer  md:place-self-center font-jak  text-slate-800 text-md text-center font-semibold p-4 border-white rounded-lg  hover:border-slate-300 hover:shadow-lg hover:bg-orange-100 transition duration-200'>
                    <img src={myImage4} alt="" className='h-[120px] sm:h-[150px] border rounded-full border-slate-300'  />
                    <h3 className='py-4'>Gifts for Him</h3>
                </div>
                <div className='cursor-pointer col-span-2 md:col-auto md:place-self-center font-jak text-slate-800 text-md text-center font-semibold p-4 border-white rounded-lg  hover:border-slate-300 hover:shadow-lg hover:bg-orange-100 transition duration-200'>
